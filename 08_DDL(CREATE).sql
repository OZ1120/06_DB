...
COMMENT ON COLUMN "MEMBER".MAMBER_NAME IS '회원 이름';
...
INSERT INTO "MEMBER" (MEMBER_ID, MEMBER_PW, MAMBER_NAME, MEMBER_SSN)
VALUES ('MEM04', 'QWERASD' , '신짱구', '960606-1234567');
...
-- ORA-02291: 무결성 제약조건(KH_LEJ.GRADE_CODE_FK1)이 위배되었습니다
-- - 부모 키가 없습니다
...
DELETE FROM USER_GRADE
WHERE GRADE_CODE = 30;
-- ORA-02292: 무결성 제약조건(KH_LEJ.GRADE_CODE_FK1)이 위배되었습니다
-- - 자식 레코드가 발견되었습니다
